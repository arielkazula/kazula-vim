...
-- 1. Helper Functions ----------------------------------------------------
-- (Custom logic used in various mappings)
...
wk.add({
    -- Navigation (Flash.nvim: modern / and ? replacement)
    -- Flash allows jumping anywhere with minimal keystrokes.
    ...
    -- Search & Replace (Grug-Far: replacement for spectre)
    -- Grug-Far is more intuitive than spectre, providing an editable search buffer.
    ...
    -- Tasks / Run (Overseer: replacement for greyjoy)
    ...
    -- Persistence automatically saves and restores your Neovim sessions.
